    ...
    $.fn.jPaginate = function(options) {
        ...
        return this.each(function() {
            ...
            function createPagination(curr) {
                ...
                var next = "", next_inactive = "", previous = "", previous_inactive = "";
                var show_all = "";
                start = "<ul class='"+options.pagination_class+"'>";

                if(options.show_next){
                    next = "<li><a class='goto_next' href='#'>"+options.next+"</a></li>";
                    next_inactive = "<li><a class='inactive'>"+options.next+"</a></li>";
                } 

                if(options.show_prev){
                    previous = "<li><a class='goto_previous' href='#'>"+options.previous+"</a></li>";
                    previous_inactive = "<li><a class='inactive'>"+options.previous+"</a></li>";
                }

                if(options.show_all){
                    show_all = "<li><a class='show_all'>"+options.show_all_text+"</a></li>";
                }               
                ...
                if (curr != 1 && curr != number_of_pages) {
                    nav = start + previous + items + next + show_all + end;
                } else if (number_of_pages == 1) {
					nav = start + previous_inactive + items + next_inactive + show_all + end;
				} else if (curr == number_of_pages){
                    nav = start + previous + items + next_inactive + show_all + end;
                } else if (curr == 1) {
                    nav = start + previous_inactive + items + next + show_all + end;
                }
...
((expiredays==null)?"":";expires="+exdate.toUTCString());
            ...
            $(".show_all").live("click", function(e) {
                e.preventDefault();
